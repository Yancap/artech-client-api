...
INSERT INTO managements (id, email,name,password,role,url_avatar)
  VALUES(100, 'johndoemanager@email.com','John Doe','123','Author','');
...
INSERT INTO categories (id, category) VALUES (100, 'teste 1');
INSERT INTO categories (id, category) VALUES (200, 'teste 2');
...
INSERT INTO articles (id,category_id, manager_id, created_at, updated_at, current_state, image_url, slug, subtitle, text, title)
  VALUES (101, 100, 100 , CURRENT_DATE, CURRENT_DATE, 'active', '', 'article-example-64', 'article example', 'article example','Article Node');

INSERT INTO articles (id,category_id, manager_id, created_at, updated_at, current_state, image_url, slug, subtitle, text, title)
  VALUES (102, 100, 100 , CURRENT_DATE, CURRENT_DATE, 'active', '', 'article-example-23', 'article od javascript js', 'article example','Article');

INSERT INTO articles (category_id, manager_id, created_at, updated_at, current_state, image_url, slug, subtitle, text, title)
  VALUES (200,100, CURRENT_DATE, CURRENT_DATE, 'disabled', '', 'article-disabled-1', 'article disabled ', 'article disabled','Article Disabled');
